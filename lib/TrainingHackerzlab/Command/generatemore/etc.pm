package TrainingHackerzlab::Command::generatemore::etc;
use Mojo::Base 'Mojolicious::Command';
use Mojo::Util qw{dumper class_to_file class_to_path};

has description => 'TrainingHackerzlab create etc';
...
TrainingHackerzlab::Command::generatemore::etc - TrainingHackerzlab create etc

=head1 SYNOPSIS

  Usage: carton exec -- script/training_hackerzlab generatemore etc [OPTIONS]
