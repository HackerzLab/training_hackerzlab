...
問題集 -> 「全ての問題をとく」を追加、これを問題集ID 1 に設定、他すべて繰り上げ
問題集経由からでしか問題を解けないようにしておく
解答入力、ヒント開封履歴は必ず問題集IDを入力する 0 は認めない
問題集からの「全ての問題をとく」を有効にする
成績一覧の問題集に「全ての問題をとく」を追加
成績一覧から「全ての問題をとくの成績一覧」を削除
関連するテンプレ、コントローラーなどを削除
メニューの「全ての問題をとく」を廃止、関連項目削除

メニューに「問題を追加する」を新設
問題の一覧と検索機能追加
問題新規追加機能追加
    問題を新規追加時、公開を許可すると自動的に問題集の「全ての問題をとく」に追加
問題編集機能追加
メニューに「問題集を追加する」を新設
問題集の一覧と検索機能追加
問題集新規追加機能追加
問題集編集機能追加
メニューに「問題を問題集に追加する」を新設
追加する機能および画面を新設
問題集のpasscode機能の検討
問題を追加する機能を使えるユーザーを限定する
現行のシステムの問題データをダンプしてくる
```
